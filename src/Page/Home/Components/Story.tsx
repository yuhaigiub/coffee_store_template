...
const Story = () => {
	return (
		<div className="md:bg-black relative w-full">
			<div className="h-40 bg-pink-300 md:w-[45vw] md:h-[55vh]"></div>
			<div className="bg-[#232323] text-white py-16 px-8 md:w-[40vw] md:absolute top-16 left-[38vw] md:opacity-80">
				<h2 className="text-2xl mb-4 text-center">DISCOVER OUR STORY</h2>
