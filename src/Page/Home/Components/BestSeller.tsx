		...
		<div className="bg-[#232323] text-white py-16 px-8 md:py-36 md:px-48">
			...
			<div className="flex flex-col gap-8 md:flex-row md:justify-center">
				<Item
					...
					img={<img src="menu1.webp" className="bg-pink-300 aspect-square md:h-36" />}
				/>
				<Item
					name="Espresso"
					price={4.99}
					description="A small river named Duden flows by their place and supplies"
					img={<img src="menu2.webp" className="bg-green-300 aspect-square md:h-36" />}
				/>
				<Item
					name="Black Coffee"
					price={1.99}
					description="A small river named Duden flows by their place and supplies"
					img={<img src="menu3.webp" className="bg-blue-300 aspect-square md:h-36" />}
				/>
				<Item
					name="Milk Coffee"
					price={2.79}
					description="A small river named Duden flows by their place and supplies"
					img={<img src="menu4.webp" className="bg-yellow-300 aspect-square md:h-36" />}
				/>
			</div>
		</div>
	);
